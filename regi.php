            ...
            <form id="sign_up" name="sign_up_form" class="register-form needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  method="post" onsubmit="return validate();" novalidate>
              ...
              <div class="form-group">
                ...
                <div class="form-group row align-self-center">
                    <input type="submit" name="btn_sign_up" class="col ml-2 mr-2 btn btn-info btn-block btn-round" value="Register">
                  ...
                  <!-- <a href="#" class="btn btn-link btn-danger" style="margin-top: 10px">Already have an account?<br>Login here</a> -->
                    <button type="button" name="btn_log" class="btn btn-primary btn-round" href="http://localhost/TMS/dummytests/login.php">
                        <span class="text-dark text-center h6"><a href="http://localhost/TMS/dummytests/login2.php">Login to account</a></span> 
                    </button>
                </div>
            </form>
          </div>
...
$sql1 = "SELECT userid,username,emailid,password,contactno,uidai FROM user WHERE username='".$username."' OR emailid='".$email."' OR contactno='".$Contact_no."' OR uidai='".$uidai."';";
