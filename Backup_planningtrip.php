        ...
        $pkgDetails=mysqli_query($conn, $pkg);
            ...
            if (mysqli_num_rows($userDetails) > 0) {
                      while($row = mysqli_fetch_assoc($pkgDetails)) {
                        ...
                        $mealPrice = $row["mealPrice"];
                        $Accommodation = $row["Accommodation"];
                        $img =str_ireplace("C:/xampp/htdocs/TMS/dummytests/pkgStock","pkgStock",$row["img"]);
                          ...
                          if($destination=="Himachal"){
                            ...
                            echo "<div class=\"form-group card ml-auto mr-auto\" style=\"width: 20rem;\">
                                  ...
                                  <div class=\"card-body\">
                                    ...
                                    <input type=\"hidden\" name=\"rowid".$count."\" value='".htmlentities($count)."'>
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title punchline">Planning on group trip?</h2>
            <p class="description punchline">Cause if you do, you're in for the treat! Hit the button below and make astonishing memories.</p>
          </div>
          <div class="col-md-5 ml-auto mr-auto download-area">
            <a href="http://www.creative-tim.com/product/paper-kit-2" class="btn btn-outline-info btn-round punchline block__link px-2" data-fx="7" data-img="ImageRevealHover/img/47.jpg"><i class="fas fa-lg fa-users mr-1"></i>Group Trip</a>
          </div>
        </div>
        <div class="row text-center upgrade-pro">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <p class="description punchline">Kiss your home goodbye and just
              <a href="#" class="text-danger punchline block__link" target="_blank" data-fx="3" data-img="ImageRevealHover/img/12.jpg">do it!</a>
          </div>
          <div class="col-sm-5 ml-auto mr-auto">
            <a href="#" class="btn btn-outline-primary btn-round punchline px-2 block__link" target="_blank" data-fx="5" data-img="ImageRevealHover/img/46.jpg"><i class="nc-icon nc-headphones mr-1" aria-hidden="true"></i> Solo Trip</a>
          </div>
        </div>
      </div>
    </div> -->
